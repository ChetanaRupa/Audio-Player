...
rootpath="C:\\Users\DELL\Music\chetana music"
pattern="*.mp3"
...
listBox=tk.Listbox(canvas,fg="white",bg="black",width=100,font=('//',14))
listBox.pack(padx=15,pady=15)

label=tk.Label(canvas,text="",bg="white",fg="black",font=("Roboto",18))
label.pack(pady=15)
